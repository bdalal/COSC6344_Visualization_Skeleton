...
PlyProperty vert_props[] = { /* list of property information for a vertex */
  ...
  {"angle_deficit", Float32, Float32, offsetof(Vertex_io, angle_deficit), 0, 0, 0, 0},
  {"nx", Float32, Float32, offsetof(Vertex_io,nx), 0, 0, 0, 0},
  {"ny", Float32, Float32, offsetof(Vertex_io,ny), 0, 0, 0, 0},
  {"nz", Float32, Float32, offsetof(Vertex_io,nz), 0, 0, 0, 0}
};
